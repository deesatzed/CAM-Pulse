"""Budget-aware prompt adaptation.

Adapted from ClawWork's live_agent_prompt.py tier-specific guidance pattern.
Generates budget hints for agent system prompts based on remaining
token budget and iteration position.

This is pure computation, no I/O, no async.
"""
...
def generate_budget_hint(
    ...
    """Generate a budget guidance hint for the agent prompt.
    ...
    # Calculate the deadline for submitting code
